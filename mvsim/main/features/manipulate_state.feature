...
#	Scenario: manipulate_state.feature 1. Default state is disabled
#        Using selenium
...
#        And I see "This state is the default starting state for the MV Sim application. The variables and coefficients cannot be changed."
#        And there is not a submit button
#        
