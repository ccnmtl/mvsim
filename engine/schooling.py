class SchoolingFSM:
    ...
    def calculate_next_state(self,enroll):
        ...
        # are mapped
        functions = {"under 5"                              : self.under5_fsm,
                     ...
                     "enrolled in primary but missed turn"  : self.enrolled_in_primary_but_missed_turn_fsm,
                     "eligible for primary but missed turn" : self.eligible_for_primary_but_missed_turn_fsm,
                     }
