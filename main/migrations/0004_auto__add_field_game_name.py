...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_game', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.name'
        db.delete_column('main_game', 'name')
